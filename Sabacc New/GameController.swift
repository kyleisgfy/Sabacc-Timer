...
//        timer = Timer.scheduledTimer(timeInterval: TimeInterval(randomTimeInterval), target: self, selector: #selector(GameController.timerDidFire), userInfo: nil, repeats: false)
//        
//    }
}
